...
using EurekaBank_RestFull_DotNet_GR01.Filters;
...
{
    // Agregar filtro global de validación
    options.Filters.Add<ValidacionFilter>();
})
// Deshabilitar el comportamiento automático de validación para usar el nuestro
