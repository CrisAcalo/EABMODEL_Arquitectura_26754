...
CREATE TABLE Sucursal (
    chr_sucucodigo       INT NOT NULL AUTO_INCREMENT,
    ...
    dec_suculatitud      DECIMAL(10, 8) NULL,
    dec_suculongitud     DECIMAL(11, 8) NULL,
...
CREATE TABLE Cuenta (
    ...
    chr_cliecodigo       CHAR(5) NOT NULL,
    dec_cuensaldo        DECIMAL(15,2) NOT NULL,
...
CREATE TABLE Movimiento (
    ...
    chr_emplcodigo       CHAR(4) NOT NULL,
    chr_tipocodigo       CHAR(3) NOT NULL,
    dec_moviimporte      DECIMAL(15,2) NOT NULL,
...
CREATE TABLE CostoMovimiento (
    chr_monecodigo       CHAR(2) NOT NULL,
    dec_costimporte      DECIMAL(15,2) NOT NULL,
...
CREATE TABLE CargoMantenimiento (
    chr_monecodigo       CHAR(2) NOT NULL,
    dec_cargMontoMaximo  DECIMAL(15,2) NOT NULL,
    dec_cargImporte      DECIMAL(15,2) NOT NULL,
