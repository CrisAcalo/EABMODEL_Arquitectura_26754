...
namespace UniversalConverter.Client.Services
{
    public class SoapConversionService : IConversionService
    {
        ...
        private string DotNetLongitudUrl => $"http://{_configuration["Hosts"]}:8082/ec/edu/monster/ws/LongitudService.svc";
        private string DotNetMasaUrl => $"http://{_configuration["Hosts"]}:8082/ec/edu/monster/ws/MasaService.svc";
        private string DotNetTemperaturaUrl => $"http://{_configuration["Hosts"]}:8082/ec/edu/monster/ws/TemperaturaService.svc";
        private string JavaLongitudUrl => $"http://{_configuration["Hosts"]}:8080/ConUni_Soap_Java_GR01/LongitudService";
        private string JavaMasaUrl => $"http://{_configuration["Hosts"]}:8080/ConUni_Soap_Java_GR01/MasaService";
        private string JavaTemperaturaUrl => $"http://{_configuration["Hosts"]}:8080/ConUni_Soap_Java_GR01/TemperaturaService";

        public SoapConversionService(IConfiguration configuration)
        {
