...
import ec.edu.monster.longitud.*;
 ...
 * @author Kewo
 */
@WebServlet(name = "LongitudServlet", urlPatterns = {"/LongitudServlet"})
public class LongitudServlet extends HttpServlet {
    @Override
    protected void doPost(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            ...
            String serviceName = ConfigManager.getProperty("servicio.longitud");
            ...
            LongitudService_Service service = new LongitudService_Service(wsdlURL, qname);
            LongitudService port = service.getLongitudServicePort();
            
            ConversionResult resultado = null;
            
            switch (tipoConversion) {
                case "millaMetro":
                    resultado = port.millaAMetro(valor);
                    break;
                case "metroMilla":
                    resultado = port.metroAMilla(valor);
                    break;
                case "millaPulgada":
                    resultado = port.millaAPulgada(valor);
                    break;
                case "pulgadaMilla":
                    resultado = port.pulgadaAMilla(valor);
                    break;
                case "metroPulgada":
                    resultado = port.metroAPulgada(valor);
                    break;
                case "pulgadaMetro":
                    resultado = port.pulgadaAMetro(valor);
                    break;
            }
            ...
            if (resultado != null && resultado.isExitoso()) {
                ...
                request.setAttribute("resultadoLongitud", htmlResultado);
                ...
                request.setAttribute("errorLongitud", htmlError);
            }
