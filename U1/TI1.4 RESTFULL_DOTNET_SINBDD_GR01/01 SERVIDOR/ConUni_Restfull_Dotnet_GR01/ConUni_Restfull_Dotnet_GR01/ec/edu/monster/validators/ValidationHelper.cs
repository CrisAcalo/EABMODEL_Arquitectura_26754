...
namespace ConUni_Restfull_Dotnet_GR01.ec.edu.monster.validators
{
    /// <summary>
    ...
    public static class StringToNumberValidator
    {
        ...
        /// <returns>ConversionErrorModel si hay error, null si es válido</returns>
        public static ConversionErrorModel? ValidarYConvertirADouble(string valorString, string unidad, out double valor)
        {
            valor = 0.0;
    ...
    public static class BaseValidator
    {
        ...
        /// <returns>ConversionErrorModel si hay error, null si es válido</returns>
        public static ConversionErrorModel? ValidarNumeroValido(double valor, string unidad)
        {
        ...
        /// <param name="unidad">Nombre de la unidad para el mensaje de error</param>
        /// <returns>ConversionErrorModel si hay error, null si es válido</returns>
        public static ConversionErrorModel? ValidarValorPositivo(double valor, string unidad)
        {
        ...
        /// <param name="valor">Valor convertido (output)</param>
        /// <returns>ConversionErrorModel si hay error, null si es válido</returns>
        public static ConversionErrorModel? ValidarStringPositivo(string valorString, string unidad, out double valor)
        {
    ...
    public static class TemperaturaValidator
    {
        ...
        /// <returns>ConversionErrorModel si hay error, null si es válido</returns>
        public static ConversionErrorModel? ValidarStringTemperaturaCelsius(string celsiusString, out double celsius)
        {
            // Primero convertir string a double
        ...
        /// <returns>ConversionErrorModel si hay error, null si es válido</returns>
        public static ConversionErrorModel? ValidarStringTemperaturaFahrenheit(string fahrenheitString, out double fahrenheit)
        {
            // Primero convertir string a double
        ...
        /// <returns>ConversionErrorModel si hay error, null si es válido</returns>
        public static ConversionErrorModel? ValidarStringTemperaturaKelvin(string kelvinString, out double kelvin)
        {
            // Primero convertir string a double
        ...
        /// <returns>ConversionErrorModel si hay error, null si es válido</returns>
        public static ConversionErrorModel? ValidarTemperaturaCelsius(double celsius)
        {
            // Primero validar que sea un número válido
        ...
        /// <returns>ConversionErrorModel si hay error, null si es válido</returns>
        public static ConversionErrorModel? ValidarTemperaturaFahrenheit(double fahrenheit)
        {
            // Primero validar que sea un número válido
        ...
        /// <returns>ConversionErrorModel si hay error, null si es válido</returns>
        public static ConversionErrorModel? ValidarTemperaturaKelvin(double kelvin)
        {
            // Primero validar que sea un número válido
