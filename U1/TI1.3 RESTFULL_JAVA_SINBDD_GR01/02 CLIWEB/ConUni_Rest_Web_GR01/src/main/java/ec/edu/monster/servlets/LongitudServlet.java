...
/**
 * Servlet para conversiones de longitud via REST
 * @author YourName
 */
    ...
    protected void doPost(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            ...
            switch (tipoConversion) {
                ...
                case "millaPulgada":
                    unidadOrigen = "Milla";
                    unidadDestino = "Pulgada";
                    break;
                case "pulgadaMilla":
                    unidadOrigen = "Pulgada";
                    unidadDestino = "Milla";
                    break;
                case "metroPulgada":
                    unidadOrigen = "Metro";
            ...
            String endpoint = ConfigManager.getEndpointURL("longitud");
            ...
            if (resultado != null && resultado.isExitoso()) {
                ...
                // Si la respuesta no tiene la estructura esperada, mostrar el JSON crudo
